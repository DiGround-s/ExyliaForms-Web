...
import { Loader2, Upload, X, AlertTriangle, Shuffle, ChevronDown } from "lucide-react"
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-3">
            <div className="space-y-1.5">
              <Label className="text-xs text-muted-foreground">{t("discord.embedTitle")}</Label>
              <Input value={data.title} onChange={(e) => onChange({ title: e.target.value })} maxLength={256} />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs text-muted-foreground">{t("discord.embedDescription")}</Label>
              <Textarea
            ...
            {hasCooldown && (
              <div className="space-y-1.5">
                <Label className="text-xs text-muted-foreground">{t("discord.embedCooldown")}</Label>
                <Input
                  value={data.cooldown ?? ""}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs text-muted-foreground">{t("discord.embedFooter")}</Label>
              <Input value={data.footer} onChange={(e) => onChange({ footer: e.target.value })} maxLength={2048} />
            </div>
            <div className="flex items-center gap-3">
              <Label className="text-xs text-muted-foreground">{t("discord.embedColor")}</Label>
              <div className="flex items-center gap-2">
                <input
                  type="color"
                  value={data.color}
            ...
            <p className="text-xs text-muted-foreground">
              <span className="font-medium">{t("discord.vars")}:</span>{" "}
              {vars.map((v) => (
          ...
          <div className="space-y-2">
            <p className="text-xs font-medium text-muted-foreground">{t("discord.previewTitle")}</p>
...
function DiscordPreview({ data, hasCooldown }: { data: EmbedData; hasCooldown?: boolean }) {
